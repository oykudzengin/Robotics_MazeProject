...
bool laser_angle_range_cartesian_offset(silver_fundamentals::LaserCartesian::Request& req, silver_fundamentals::LaserCartesian::Response& res) {
    double min_angle = req.start;
    double max_angle = req.end;
    double max_dist = req.max_dist/100.0;
    int min_index = static_cast<int>(
...
int main(int argc, char** argv)
{
    ...
    ros::ServiceServer service2 = n.advertiseService("laserAngleRangeCartesian", laser_angle_range_cartesian);
    ros::ServiceServer service3 = n.advertiseService("laserAngleRangeCartesianOffset", laser_angle_range_cartesian_offset);
